  ...
  const benefits = [
    {
      ...
      bgColor: "bg-green-50",
      description:
        "See measurable progress in just 4 weeks with AI-optimized workout plans",
    },
    {
      id: 2,
      icon: FiHeart,
      ...
      bgColor: "bg-red-50",
      description:
        "Improve cardiovascular health, strength, and overall fitness safely",
    },
    {
      id: 3,
      icon: FiAward,
      ...
      description:
        "Earn badges, streak rewards, and celebrate milestones daily",
    },
    {
      id: 4,
      icon: FiTarget,
    ...
    },
    {
      ...
      description:
        "Get AI coaching tailored to your unique body and fitness level",
    },
    {
      id: 6,
      icon: FiClock,
    ...
    },
    {
      ...
      bgColor: "bg-cyan-50",
      description:
        "Connect with thousands of users on the same fitness journey",
    },
    {
      id: 8,
      icon: FiZap,
      ...
      description:
        "Develop consistent fitness habits with daily tracking and reminders",
    },
  ];
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg sm:text-xl text-gray-600 max-w-3xl mx-auto animate-slideDown animation-delay-400">
                More than just a fitness app - it's your personal AI coach,
                nutritionist, and accountability partner combined.
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {benefits.map((benefit, index) => {
                ...
                return (
                  ...
                  >
                    <div
                      className={`${benefit.bgColor} rounded-2xl p-6 h-full transition-all duration-500 hover:shadow-2xl hover:-translate-y-2 cursor-pointer`}
                    >
                      {/* Icon */}
                      <div
                        className={`inline-flex items-center justify-center w-14 h-14 rounded-xl bg-gradient-to-br ${benefit.color} text-white mb-4 group-hover:scale-110 transition-transform duration-300`}
                      >
        ...
        <section className="px-4 sm:px-6 lg:px-8 py-20 bg-gradient-to-b from-gray-50 to-white">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600">Real data from real users</p>
            </div>
              ...
              {[
                {
                  ...
                  description:
                    "All workouts and meal plans are based on latest fitness science and research",
                },
                {
                  title: "Flexible & Adaptable",
                  description:
                    "Plans adjust based on your performance, schedule changes, and feedback",
                },
                {
                  title: "Privacy First",
                  description:
                ...
                },
                {
                  title: "Affordable",
                  description:
                    "Premium features at a fraction of personal trainer costs",
                },
                {
                  title: "Always Available",
                  description:
                    "24/7 access to your coach, meals plans, and support community",
                },
                {
              ...
              {testimonials.map((testimonial, index) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-4">
                    <div
                      className={`w-12 h-12 rounded-full bg-gradient-to-br ${testimonial.color} flex items-center justify-center text-2xl`}
                    >
                      {testimonial.avatar}
                    </div>
                    <div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-gradient-to-r from-green-600 via-emerald-600 to-cyan-600 rounded-3xl px-8 sm:px-12 md:px-16 py-16 sm:py-20 text-center">
              ...
              <p className="text-lg sm:text-xl text-green-100 mb-8 max-w-2xl mx-auto">
                Join 100K+ users already transforming their lives with
                NavKalpana
              </p>
