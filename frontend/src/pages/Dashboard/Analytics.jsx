...
const Analytics = () => {
  ...
  const [weightAnalysisData] = useState([
  ...
  // Mock data for workout patterns by day
  const [workoutByDayData] = useState([
    { day: 'Mon', workouts: 12 },
    { day: 'Tue', workouts: 15 },
    { day: 'Wed', workouts: 10 },
    { day: 'Thu', workouts: 14 },
  ...
  // Mock data for workout types
  const [workoutTypesData] = useState([
  ...
  // Mock data for nutrition macros
  ...
  // Mock data for macro distribution (average)
  const [macroDistributionData] = useState([
    { name: 'Protein', value: 30, color: '#ef4444' },
    { name: 'Carbs', value: 50, color: '#3b82f6' },
    { name: 'Fats', value: 20, color: '#f59e0b' },
  ]);

  // Mock data for correlation insights
  const [sleepWorkoutData] = useState([
  ...
  // Mock data for weight forecast
  const [weightForecastData] = useState([
  ...
  const handleGenerateReport = () => {
    alert('Generate Report - PDF/Excel export to be implemented');
  };

  // Calendar heat map (simplified representation)
      ...
      <div className="analytics-section correlation-section">
        ...
        <div className="correlation-summary">
          <div className="correlation-card">
            <h4>🌙 Sleep Quality</h4>
            <p>Strong positive correlation with workout performance (r = 0.89)</p>
          </div>
          <div className="correlation-card">
