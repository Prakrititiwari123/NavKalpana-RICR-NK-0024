...
const Dashboard = () => {
  ...
  const progressPercentage =
    ((userData.currentWeight - userData.startWeight) /
      (userData.goalWeight - userData.startWeight)) *
    100;
    ...
    <DashboardLayout>
      <div className="min-h-screen bg-linear-to-br from-white via-blue-50 to-indigo-50 relative overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none overflow-hidden">
          ...
          <div
            className="absolute -bottom-40 -left-40 w-80 h-80 rounded-full bg-indigo-100 mix-blend-multiply filter blur-3xl opacity-30 animate-pulse-slow"
            style={{ animationDelay: "2s" }}
          ></div>
          <div
            className="absolute top-1/2 left-1/2 w-96 h-96 rounded-full bg-purple-100 mix-blend-multiply filter blur-3xl opacity-20 animate-pulse-slow"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 relative z-10">
            ...
            <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4">
              <div>
                <h1 className="text-4xl md:text-5xl font-bold bg-linear-to-r from-blue-600 via-indigo-600 to-purple-600 bg-clip-text text-transparent mb-2">
                  Welcome back, {parsedUser?.fullName || "Alex"}!
                </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            {/* Habit Score Card */}
            <div
              className="bg-white rounded-2xl shadow-lg p-6 border border-gray-100 hover:shadow-xl transition-all duration-300 hover:scale-105 animate-fadeInUp"
            ...
            >
              <div className="flex items-start justify-between mb-4">
                ...
                <span
                  className={`text-sm font-semibold ${userData.weightChange < 0 ? "text-green-600" : "text-red-600"}`}
                >
              ...
              <p className="text-xs text-green-600 font-semibold">
                From start: {userData.weightChange} kg
              </p>
            </div>
            ...
            >
              <div className="flex items-start justify-between mb-4">
                ...
                <span className="text-sm font-semibold text-red-600">
                  {Math.round(
                    (userData.calories / userData.caloriesTarget) * 100,
                  )}
                  %
                </span>
              </div>
              ...
              <div className="mb-3">
                ...
                <p className="text-xs text-gray-500">
                  of {userData.caloriesTarget} kcal
                </p>
              </div>
              <div className="w-full bg-gray-200 rounded-full h-2">
                <div
                  ...
                  style={{
                    width: `${Math.min((userData.calories / userData.caloriesTarget) * 100, 100)}%`,
                  }}
                ></div>
              </div>
            </div>
            ...
            >
              ...
              <div className="mb-3">
                ...
                <p className="text-xs text-gray-500">
                  {userData.exercisesToday} exercises
                </p>
              </div>
          ...
          <div
            className="bg-white rounded-2xl shadow-lg p-8 border border-gray-100 mb-8 animate-fadeInUp"
            ...
            <div className="mb-8 p-6 bg-linear-to-r from-blue-50 to-indigo-50 rounded-xl">
              ...
              <div className="flex items-center justify-between mb-4 text-sm">
                <span className="text-gray-600">
                  <span className="font-semibold">{userData.startWeight}</span>{" "}
                  kg
                </span>
                <span className="text-gray-600">
              ...
              {[
                {
                  ...
                  value: weeklyStats.workoutCompletion,
                  color: "from-purple-500 to-pink-500",
                },
                {
                  label: "Diet Adherence",
                  value: weeklyStats.dietAdherence,
                  color: "from-green-500 to-emerald-500",
                },
                {
                  label: "Energy Level",
                  value: weeklyStats.energyLevel,
                  isText: true,
                },
              ].map((stat, index) => (
                <div
