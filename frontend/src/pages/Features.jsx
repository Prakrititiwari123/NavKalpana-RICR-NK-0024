                      ...
                      <ul className="space-y-4">
                        {feature.highlights.map((highlight, idx) => (
                          <li key={idx} className="flex items-start gap-3">
                            <div className={`shrink-0 w-5 h-5 rounded-full bg-linear-to-br ${feature.color} text-white flex items-center justify-center mt-0.5`}>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                ...
                >
                  <div className={`shrink-0 w-12 h-12 rounded-full bg-${item.color}-100 text-${item.color}-600 flex items-center justify-center text-xl font-bold`}>
                    {item.value}
                  </div>
